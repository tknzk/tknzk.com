...
get '/.well-known/did.json' do
  ...
  did = <<_EOS_;
{
  "id": "did:web:www.tknzk.com",
  "@context": [
    "https://www.w3.org/ns/did/v1",
    {
      "@base": "did:web:www.tknzk.com"
    }
  ],
  "service": [
    {
    ...
    },
    {
      ...
      "serviceEndpoint": {
        "instances": [
          "https://hub.did.msidentity.com/v1.0/313eb7a4-2876-4aab-ba7f-e38e8708a124"
        ]
      }
    }
  ],
  "verificationMethod": [
    {
      "id": "#35359585bfca4c02bd77a557a7da64c3vcSigningKey-a3e41",
      "controller": "did:web:www.tknzk.com",
      "type": "EcdsaSecp256k1VerificationKey2019",
      "publicKeyJwk": {
        "crv": "secp256k1",
        "kty": "EC",
        "x": "havNHZvAA_Vaf2TqaerZkStUXfNMUeR1OJa-9uEz_3Q",
        "y": "XosMcydAq7oxf1M0XhUl8aOe3xTbNqhDKS1j-etAWWQ"
      }
    }
  ],
  "authentication": [
    "#35359585bfca4c02bd77a557a7da64c3vcSigningKey-a3e41"
  ],
  "assertionMethod": [
    "#35359585bfca4c02bd77a557a7da64c3vcSigningKey-a3e41"
  ]
